...
<div class="container">
    ...
    <div class="infos-detail mb-4">
        <?php echo form_open('me', array('id' => 'formProfil', 'class' => 'col-sm-10 col-md-8 col-lg-7 col-centered')); ?>
...
<div class="container">
    ...
    <div class="infos-detail">
        <?php echo form_open(base_url('me/password'), array('id' => 'formInscription', 'class' => 'col-sm-10 col-md-8 col-lg-7 col-centered')); ?>

        <div class="form-group row">
            <label for="username" class="col-md-5 col-lg-4 col-form-label">Ancien mot de passe</label>
            <div class="col-sm-12 col-md-7 col-lg-8">
                <input id="password" type="password" name="current" class="form-control" value="">
            </div>
        </div>
